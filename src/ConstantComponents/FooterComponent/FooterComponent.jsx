...
function FooterComponent() {
  return (
    <div className='min-h-[200px] bg-bbb w-full grid grid-cols-1 items-center justify-center lg:grid-cols-3 p-[10px] mt-[20px]'>
        <div>
        ...
        <div className='flex items-center  justify-center'>
           <h1 className='flex items-center text-[20px] text-textc font-bold'>Lawn <ImScissors className='text-[40px] md:text-[70px] lg:text-[90px] text-[#f1c40f]'/> CUTz</h1>
