...
function AboutComponent3() {
  return (
    <div className='min-h-[700px] md:min-h-[650px] lg:min-h-[400px] grid grid-cols-1 lg:grid-cols-2 gap-[80px] lg:gap-0 aboutbc'>
        <div className='min-h-[400px] relative'>
            <div className='min-h-[150px] md:min-h-[200px] lg:min-h-[200px]  w-[90%] p-[10px] mt-[10px] translate-x-3 md:translate-x-10 border-[2px] border-btncolo '>
                ...
                <div className='p-[20px]'>
                    ...
                    At the heart of our vision is a commitient to preserving the time-honored traditions of barbering while seamlessly blending them with contemporary techniques and trends. We envision a space where heritage and innovation zo exist harmoniously, creating an environment that appeals to the modern man seeking both classic sophistication and cutting-edge styles
                    </p>
                </div>
