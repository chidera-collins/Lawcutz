    ...
    <div className='w-full h-[300px] md:hidden lg:hidden slider-container bg-MainBg p-[10px]' >
        <Slider {...settings}>
            <div className='h-[200px] relative'>
                ...
                <div className=' h-[30px] w-full absolute bottom-[20px] flex items-center justify-center text-btncolo font-bold text-5xl'>
                    <h1># 1</h1>
                </div>
                 <div className='  absolute bottom-[18px] flex items-center justify-center text-textc w-full font-bold text-2xl  opacity-3'>
                     <h1>SLICK BLACK</h1>
                 </div>
            </div>
            <div className='h-[200px] relative'>
