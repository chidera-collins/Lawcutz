  ...
  return (
   <div className=''>
        ...
        <div className='min-h-[200px] w-full text-textc  text-9xl tracking-widest items-center gap-[10px] font-bold hidden md:flex lg:hidden bg-MainBg p-[10px] movetext'>
            <h1 className='conn'>HAIRCUT</h1>
        </div>
        <div className='min-h-[200px] w-full text-textc  text-[100px] tracking-widest items-center gap-[190px] font-bold hidden md:hidden lg:flex bg-MainBg p-[10px] box-border movetext'>
            <h1 className='ccon'>HAIRCUT</h1>
