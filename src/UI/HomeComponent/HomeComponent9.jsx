...
import haircut from './Homepictures/haircut.jpg'
import beard from './Homepictures/beard.jpg'
import shaving from './Homepictures/shaving.jpg'
import razor from './Homepictures/razor.jpg'

function HomeComponent9() {
  return (
    <div className='h-[1900px] md:h-[2500px] lg:h-[700px] lg:items-center w-full bg-MainBg grid grid-cols-1 lg:grid-cols-4 p-[10px] box-border gap-[10px]'>
