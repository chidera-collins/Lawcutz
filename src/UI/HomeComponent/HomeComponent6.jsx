...
function HomeComponent6() {
  ...
  return (
    <div className='w-full hidden md:hidden lg:block slider-container bg-MainBg lg:h-[550px] p-[30px] box-border'>
        <Slider {...settings}>
            <div className='h-[400px] relative'>
                ...
                <div className=' h-[30px] w-full absolute bottom-[130px] flex items-center justify-center text-btncolo font-bold text-5xl'>
                    <h1># 1</h1>
                </div>
                 <div className='  absolute bottom-[128px] flex items-center justify-center text-textc w-full font-bold text-2xl  opacity-3'>
                     <h1>SLICK BLACK</h1>
                 </div>
            </div>
